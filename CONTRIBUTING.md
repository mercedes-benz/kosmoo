...
Before you can contribute, you will need to sign the [Contributor License Agreement](https://github.com/Daimler/daimler-foss/blob/master/CONTRIBUTORS_LICENSE_AGREEMENT.md).
...
- Github for reporting and claiming issues:  https://github.com/daimler/kosmoo
...
Before you can contribute, you will need to sign our CLA and send the signed CLA to foss@daimler.com.
